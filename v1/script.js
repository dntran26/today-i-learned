...
async function loadFacts() {
  const res = await fetch(
    'https://kyhmxpcgreprgmzlshyr.supabase.co/rest/v1/facts',
    {
      headers: {
        apikey:
        ...
        authorization:
          'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imt5aG14cGNncmVwcmdtemxzaHlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTY4ODIwODcsImV4cCI6MjAzMjQ1ODA4N30.KmxBKpbQC0a3RP4k2TjsRUoe22jfIROMNI9EljzLONc',
      },
    }
  );
...
btn.addEventListener('click', function () {
  if (form.classList.contains('hidden')) {
    ...
    // document.querySelector('.btn-open').innerHTML = 'Close';
  } else {
    form.classList.add('hidden');
    btn.textContent = 'Share a fact';
    // document.querySelector('.btn-open').innerHTML = 'Share a fact';
  }
});
...
const str = `The current fact is "${upperText}". It is ${calcFactAge(2015)}
